...
const WORDS = [
  ...
  "Mentor & Junior Teaching Assistant"
];
const TECH_STACK = ["SQL", "Python", "Java", "C#", "C++", "Django", ".NET", "Pandas", "Docker"];
const SOCIAL_LINKS = [
  { icon: Linkedin, link: "https://www.linkedin.com/in/rwan-ashraf" },
  { icon: Github, link: "https://github.com/RwanAshrafff" },
  { icon: Mail, link: "mailto:rwanashraf374@gmail.com" }
];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-20"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Typing Effect */}
                <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="1000">
                ...
                {/* CTA Buttons */}
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1200">
                  <CTAButton href="#Portofolio" text="Projects" icon={ExternalLink} />
                  <CTAButton href="mailto:rwanashraf374@gmail.com?subject=Hello%20Rwan" text="Email" icon={Mail} />
                </div>

                {/* Social Links */}
                <div className="flex gap-4 justify-start w-full" data-aos="fade-up" data-aos-delay="1400">
